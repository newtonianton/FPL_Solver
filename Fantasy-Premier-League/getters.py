...
def get_player_name_to_id_map():
    """Returns a dict mapping player names to their FPL IDs."""
    data = get_data()
    mapping = {}
    for player in data['elements']:
        name = f"{player['first_name']} {player['second_name']}"
        mapping[name] = player['id']
    return mapping


names = get_player_name_to_id_map()
print(get_individual_player_data(names["Mohamed Salah"]))
